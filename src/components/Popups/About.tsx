  ...
  return (
    <div className="about-container">
      ...
      <div className="about-header">
        <div className="about-header-main border border-wave-to rounded-3xl flex flex-col items-center justify-center bg-amber-50 dark:bg-linear-to-br dark:from-[#0D1F3B] dark:to-[#2355A1] dark:bg-black dark:text-white">
          {/* Image */}
        ...
        <div className="about-header-side border border-wave-to rounded-3xl bg-amber-50 dark:bg-linear-to-br dark:from-[#0D1F3B] dark:to-[#2355A1] dark:bg-black dark:text-white">
          <div className="border-b border-wave-to p-3 pt-2 w-full">
      ...
      <div className="about-header mt-6">
        <div className="gap-6 grid">
          {/* Hobbies */}
          <div className="border border-wave-to rounded-3xl bg-amber-50 dark:bg-linear-to-br dark:from-[#0D1F3B] dark:to-[#2355A1] dark:bg-black dark:text-white">
            <div className="border-b border-wave-to p-3 pt-2 w-full">
              <p className="text-xl text-amber-500 dark:text-cyan-100 font-medium text-center about-header-copy">
