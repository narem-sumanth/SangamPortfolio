...
export default function MobileNotice({ hasOpenWindows }: { hasOpenWindows: boolean }) {
  ...
  return (
    ...
    >
      <div className="bg-window-bg border-2 border-window-border rounded-xl shadow-flat p-5 flex items-start flex-col gap-4">
        ...
        <div className="flex items-start justify-end :items-start flex-row w-full">
          <SoundHover playType="click" src="/assets/original/sounds/click_general.mp3" vol={0.5}>
            <button
              onClick={handleDismiss}
              className="shrink-0 relative inline-block px-4 py-1 pb-2 font-medium group"
            >
